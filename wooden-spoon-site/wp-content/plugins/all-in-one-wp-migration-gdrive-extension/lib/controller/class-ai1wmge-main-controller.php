...
class Ai1wmge_Main_Controller {
	...
	public function add_cron_schedules( $schedules ) {
		$schedules['weekly'] = array(
			'display'  => __( 'Weekly', AI1WMGE_PLUGIN_NAME ),
			'interval' => 60 * 60 * 24 * 7,
		);
		$schedules['monthly'] = array(
			'display'  => __( 'Monthly', AI1WMGE_PLUGIN_NAME ),
	...
	public function ai1wm_notice() {
		...
		<div class="error">
			<p>
				<?php
				_e(
					'All in One WP Migration is not activated. Please activate the plugin in order to use Google Drive extension.',
					AI1WMGE_PLUGIN_NAME
				);
				?>
			</p>
