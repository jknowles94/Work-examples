...
var m    = require('./jquery/modal'),
	Vue  = require('./vendor/vue.min'),
	$    = jQuery,
	v    = false,
	item = false,
	path = '';

// Strip path out of the name
...
var browse_folder = function (folderId) {
	v.files = false;
...
var browse_file = function (file) {
	item = file;

	v.selected_file_name = false;
	setTimeout(function () {
		v.selected_file = file.id;
		v.selected_file_name = file.name;
	}, 1);
};

var browse_unknown_file = function (file) {
			...
			v = new Vue({
				...
				methods: {
					...
					import: function () {
						...
						var archive = item.name;

						// Set global params
						model.setParams([
							{name: 'storage', value: storage},
							{name: 'archive', value: archive},
							{name: 'fileId', value: item.id},
							{name: 'totalBytes', value: item.bytes},
							{name: 'gdrive', value: 1}
						]);
...
},{"./jquery/modal":2,"./vendor/vue.min":3}],2:[function(require,module,exports){
/**
 * Copyright (C) 2014-2015 ServMask Inc.
 *
 * This program is free software: you can redistribute it and/or modify
