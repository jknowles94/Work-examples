...
require_once "inc/region_edit.php";

add_action('admin_bar_menu', 'amigo_add_enviroment', 95);

function amigo_add_enviroment() {
...
function html5blank_nav() {
  wp_nav_menu(
    array(
      ...
      'after' => '',
      'link_before' => '',
      'link_after' => '<i class="icon-right-open"></i>',
      'items_wrap' => '<ul class="side-navigation">%3$s</ul>',
      'depth' => 0,
      'walker' => '',
    )
  );
...
function html5blank_styles() {
  wp_register_style('html5blank', get_template_directory_uri() . '/style.min.css', array(), '1.3.1', 'all');
...
function register_html5_menu() {
  register_nav_menus(array( // Using array to specify more menus if needed
    ...
    'top-header' => __('Top Header Menu', 'html5blank'),
  ));
}
