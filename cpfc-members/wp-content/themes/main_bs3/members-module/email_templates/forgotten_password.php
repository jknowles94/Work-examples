                ...
                <td>
                    <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" class="deviceWidth">
                        <tbody>
                            ...
                            <tr>
                                <td width="100%" align="left" style="color:#999999;font-size:12px;font-family:arial, sans serif; line-height:20px;">Change your password</td>
                            </tr>
                            <tr>
                                <td width="100%" height="10" style="font-size: 1px; line-height: 1px;"></td>
                            </tr>
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" align="center" width="600" class="deviceWidth" bgcolor="#ffffff">
                                                ...
                                                <td width="500">
                                                    <table cellspacing="0" cellpadding="0" border="0" align="center" width="500" class="deviceWidth" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td width="100%" class="copyblock" style="color:#000000; text-align:center;font-family:Arial, sans serif; font-size:26px; line-height:34px;text-transform:uppercase;">Your Password Reset Request</td>
                                                        </tr>
                                                        <tr>
                                                            <td width="100%" height="10" style="font-size: 1px; line-height: 1px;"></td>
                                                        </tr>
